...
const ShopComponent = ({ small = false, arts }: { small?: boolean, arts: Art[] }) => {
    ...
    const smallFormating = `flex ${showedItemsCount === 1 ? "justify-center" : "justify-between"
    ...
    const ImageChangeOnMouseOver = ({ art }: { art: Art }) => {
        return (
